...
private val roadmapStages = listOf(
    ...
    RoadmapStage(
        ...
        summary = "逐步补充车站细节，让到站前后也有帮助。",
        items = listOf(
            RoadmapItem("出入口与站内设施", "离线查看出入口、道路地标、卫生间、无障碍电梯和换乘提示。"),
            RoadmapItem("常用站收藏升级", "为车站保存常用方向、目的地、出口、自定义备注和家或公司标签。"),
            RoadmapItem("站名与线路工具", "加入拼音和模糊搜索、历史站名、同名站区分、路线反转和换乘高亮。"),
            RoadmapItem("离线应急卡", "集中显示当前位置、附近车站、已规划路线、运营服务热线和自填紧急信息。")
        )
    ),
    RoadmapStage(
        label = "有趣探索",
