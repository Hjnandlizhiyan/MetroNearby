...
- **离线应急卡**：集中查看最近定位、附近站、最近路线、官方服务热线和自填紧急联系信息；标明记录时间，号码仅打开拨号界面。
- **站名与线路工具**：首页、路线和收藏目的地支持内置站点拼音、首字母、已有别名；提供需手动确认的错字建议，结果标注城市和线路。
- **常用站与通勤方向**：收藏多个站点，保存线路、方向、家／公司／学校标签、常走出口和备注；一键规划到常用目的地。
